...
export default function Overview() {
  ...
  // ts-based history (no zeroing, no nulls)
  ...
  const avgRMS  = ((lastKnown.current.base + lastKnown.current.top) / Math.max(active, 1));
  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="flex gap-3 flex-1 min-h-0">
        {/* Gauges */}
        <div className="glass-card p-5 flex flex-col justify-around w-56 flex-shrink-0">
          ...
          <CircularGauge label="Tilt X"              value={top?.tilt_x}   max={45} unit="°"  color="#F59E0B" isOffline={!topOnline}  />
          <CircularGauge label="Tilt Y"              value={top?.tilt_y}   max={45} unit="°"  color="#F97316" isOffline={!topOnline}  />
        </div>
